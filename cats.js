...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$get', '$append_to_dom', '$each', '$append', '$find', '$[]', '$fetch', '$json', '$ready?', '$new', '$fetch!']);
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("pp");
  (function($base, $super) {
    function $RedditCatDownloader(){};
    var self = $RedditCatDownloader = $klass($base, $super, 'RedditCatDownloader', $RedditCatDownloader);
    ...
    def['$fetch!'] = function(wrapper) {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = $scope.get('HTTP')).$get, $a.$$p = (TMP_1 = function(resp){var self = TMP_1.$$s || this;
if (resp == null) resp = nil;
      return self.$append_to_dom(resp)}, TMP_1.$$s = self, TMP_1), $a).call($b, "http://www.reddit.com/r/cats/top.json");
    };

    return (def.$append_to_dom = function(resp) {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = resp.$json().$fetch("data").$fetch("children")).$each, $a.$$p = (TMP_2 = function(c){var self = TMP_2.$$s || this;
if (c == null) c = nil;
      return $scope.get('Element').$find("#redditMaster").$append("<img src='" + (c['$[]']("data")['$[]']("url")) + "'></img>")}, TMP_2.$$s = self, TMP_2), $a).call($b);
    }, nil) && 'append_to_dom';
  })(self, null);
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, cat_analizer = nil;

  cat_analizer = $scope.get('RedditCatDownloader').$new();
    return cat_analizer['$fetch!']();}, TMP_3.$$s = self, TMP_3), $a).call($b);
})(Opal);
